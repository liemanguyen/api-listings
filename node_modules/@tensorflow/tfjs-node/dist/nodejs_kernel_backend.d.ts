import { BackendTimingInfo, DataMover, DataType, KernelBackend, Rank, ShapeMap, Tensor, Tensor1D, Tensor2D, Tensor3D, Tensor4D } from '@tensorflow/tfjs-core';
...
export declare class NodeJSKernelBackend implements KernelBackend {
    ...
    scatterND<R extends Rank>(indices: Tensor<Rank>, updates: Tensor<Rank>, shape: ShapeMap[R]): Tensor<R>;
    ...
    split<T extends Tensor<Rank>>(value: T, sizeSplits: number[], axis: number): T[];
